...
Description:
Classify the overlay points as noise, so it is easier to ignore them in subsequent processes.
...
def remove_noise(obj, ibm_cos):
    ...
    out_file = res_folder + fname.name.split("/")[3].split(".")[0] + '_noOverlay.laz'
    print(out_file)
